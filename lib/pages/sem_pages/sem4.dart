...
class sem4Page extends StatefulWidget {
  static Color creamColor = const Color(0xfff5f5f5);
  static Color darkBluisColor = const Color(0xff403b58);

  const sem4Page({super.key});

  @override
  State<sem4Page> createState() => _sem4PageState();
}

class _sem4PageState extends State<sem4Page> {
  // final url = "https://upcdn.io/kW15awi/raw/catelog-4Kgi.json";
  final url = "https://mrharsh007.github.io/GtuMaterialJson/sem4.json";
  List iteams = [];
            ...
            child: Column(
              ...
              children: [
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                    "Sem - 4".text.xl3.bold.color(Colors.black).make(),
