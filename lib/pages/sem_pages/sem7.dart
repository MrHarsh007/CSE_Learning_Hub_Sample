...
class sem7Page extends StatefulWidget {
  static Color creamColor = const Color(0xfff5f5f5);
  static Color darkBluisColor = const Color(0xff403b58);

  const sem7Page({super.key});

  @override
  State<sem7Page> createState() => _sem7PageState();
}

class _sem7PageState extends State<sem7Page> {
  // final url = "https://upcdn.io/kW15awi/raw/catelog-4Kgi.json";
  final url = "https://mrharsh007.github.io/GtuMaterialJson/sem7.json";
  List iteams = [];
          ...
          child: Column(
            ...
            children: [
              Column(
                crossAxisAlignment: CrossAxisAlignment.start,
                children: [
                  "Sem - 7".text.xl3.bold.color(Colors.black).make(),
